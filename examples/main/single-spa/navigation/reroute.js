...
import { getAppStatus, getAppChanges, getMountedApps } from '../applications/apps.js';
import { callCapturedEventListeners, navigateToUrl } from './navigation-events.js';
...
export function reroute(pendingPromises = [], eventArguments) {
  ...
  function performAppChanges() {
    return Promise.resolve().then(() => {
      ...
      window.dispatchEvent(
        new CustomEvent('single-spa:before-routing-event', getCustomEventDetail(true, { cancelNavigation })),
      );
